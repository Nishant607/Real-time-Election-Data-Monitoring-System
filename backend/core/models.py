    ...
    def save(self, *args, **kwargs):
        ...
        if previous_record:
            ...
            if percentage_increase >= 50 or time_diff < 60:
                ...
                # Set this specific suspicious vote to Pending, without re-triggering save()
                VoteRecord.objects.filter(id=self.id).update(status='Pending')
...
class Anomaly(models.Model):
    ...
    vote_record = models.OneToOneField('VoteRecord', on_delete=models.CASCADE, null=True, blank=True)
